...
public class TwitterManagerImpl implements TwitterManager {
    ...
    public TwitterManagerImpl(TwitterService service) {
        this.service = service;
    }

    public void runQuery(Twitter twitter, Query aQuery, TwitterQueryListener listener) {
        service.runQuery(twitter, aQuery, listener);
    }
