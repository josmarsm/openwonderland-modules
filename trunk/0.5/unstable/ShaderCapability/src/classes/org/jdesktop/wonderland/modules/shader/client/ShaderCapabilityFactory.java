...
public class ShaderCapabilityFactory implements CellComponentFactorySPI {
    ...
    public <T extends CellComponentServerState> T getDefaultCellComponentServerState() {
        ShaderComponentServerState state = new ShaderComponentServerState();
        return (T) state;
    }

    public String getDescription() {
        return "Add Vertex and Fragment shaders to an object.";
    }
}
