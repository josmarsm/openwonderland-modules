...
public class BestViewUtils {
     ...
     */
    public static CellTransform getBestView(Cell cell, CellTransform cellTrans) {
        BoundingVolume bounds = getModelBounds(cell, cellTrans);
        ...
        // rotation
        Quaternion rotation = cellTrans.getRotation(null);
        ...
        origin.addLocal(cellTrans.getTranslation(null));

        LOGGER.fine("Origin + " + cellTrans.getTranslation(null)
                + " = " + origin);
     ...
     */
    public static BoundingVolume getModelBounds(Cell cell, CellTransform cellTrans) {
