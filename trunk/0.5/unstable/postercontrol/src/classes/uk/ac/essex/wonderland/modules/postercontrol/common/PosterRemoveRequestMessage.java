...
/**
 * Message sent to the PosterControlConnectionHandler to request that a
 * poster is removed
 *
 * @author Bernard Horan
 */
public class PosterRemoveRequestMessage extends Message {
    private int cellID;

    public PosterRemoveRequestMessage(int cellID) {
        this.cellID = cellID;
    }
