        ...
        if (menuItem instanceof EntityContextMenuItem) {
            ...
            if (entity != null && entity.hasComponent(PathNodeComponent.class)) {
                ...
                if (node != null && cell instanceof PathCell) {
                    ...
                    HeightChoiceDialogRunner.showHeightSelectionUsingAvatar(new InsertNodePositionable(path, true, node.getSequenceIndex()), node.getPosition(), cell.getWorldTransform());
                }
            }
        }
    }
