...
public class TimelineCreationHUDPanel extends javax.swing.JPanel {
    ...
    public TimelineCreationHUDPanel() {
        ...
        config = new TimelineClientConfiguration();
        initComponents();
  ...
  private void initComponents() {
      ...
      .add(layout.createSequentialGroup()
        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
          .add(layout.createSequentialGroup()
            ...
            .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
              .add(createLabel)
              .add(providersPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 604, Short.MAX_VALUE)
              .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                  ...
                  .add(layout.createSequentialGroup()
                    .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                      ...
                      .add(layout.createSequentialGroup()
                        .add(109, 109, 109)
                        .add(numSegmentsLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 21, Short.MAX_VALUE)))
                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                    .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
          ...
          .add(layout.createSequentialGroup()
            .add(60, 60, 60)
            .add(segmentsLabel, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 149, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
        .addContainerGap())
    );
    ...
    layout.setVerticalGroup(
      ...
      .add(layout.createSequentialGroup()
        ...
        .add(providersLabel)
        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        .add(providersPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 22, Short.MAX_VALUE)
        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
          .add(addKeywordButton)
          .add(addProviderButton))
