...
import org.jdesktop.wonderland.modules.rockwellcollins.stickynote.server.cell.SectionStyledStickyNoteCellMO;
 ...
 */
@ExperimentalAPI
public class SectionStyledStickyNoteComponentMO  extends CellComponentMO {
     ...
     */
    public SectionStyledStickyNoteComponentMO (CellMO cell) {
        super(cell);
    }
    ...
    public void setLive(boolean isLive) {
        ...
        if (isLive) {
            channelComponentRef.getForUpdate().addMessageReceiver(SectionStyledStickyNoteSyncMessage.class,
                    new StickynoteComponentMOMessageReceiver(cellRef.get()));
        } else {
            channelComponentRef.getForUpdate().removeMessageReceiver(SectionStyledStickyNoteSyncMessage.class);
        }
    }
     ...
     */
    public void sendAllClients(WonderlandClientID clientID, SectionStyledStickyNoteSyncMessage message) {
    ...
    protected String getClientClass() {
        return "org.jdesktop.wonderland.modules.rockwellcollins.stickynote.client.SectionStyledStickyNoteComponent";
    }
    ...
    private static class StickynoteComponentMOMessageReceiver extends AbstractComponentMessageReceiver {
        ...
        public void messageReceived(WonderlandClientSender sender, WonderlandClientID clientID, CellMessage message) {
            SectionStyledStickyNoteSyncMessage cmsg = (SectionStyledStickyNoteSyncMessage) message;
            ((SectionStyledStickyNoteCellMO ) getCell()).receivedMessage(sender, clientID, cmsg);
        }
    }
}
