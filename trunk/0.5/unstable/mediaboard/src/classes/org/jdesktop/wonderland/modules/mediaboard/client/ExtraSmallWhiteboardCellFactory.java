 ...
 */
@CellFactory
public class ExtraSmallWhiteboardCellFactory implements CellFactorySPI {
    ...
    public <T extends CellServerState> T getDefaultCellServerState(Properties props) {
        ...
        cellServerState.setName("Mediaboard (XS)");
        ...
        cellServerState.setPreferredHeight(450);
        cellServerState.setPreferredWidth(600);
        return (T) cellServerState;
    }

    public String getDisplayName() {
        return "Mediaboard (XS)";
    }
