...
public class HTTPDownloader extends Thread {
    ...
    public double getBandwidth() {
        ...
        if (downloadStarted() && !downloadComplete()) {
            ...
            double a = ((double)downloaded / 1024d);    // KB
            double b = (now - started) / 1000d;         // s
            bandwidth = (b > 0) ? a / b : 0;
        }
        return bandwidth;
    }
    ...
    public void download(String from, String to, long alert) {
        ...
        try {
            ...
            logger.warning("failed to retrieve file: " + e);
            reset();
        } finally {
            try {
                if (httpIS != null) {
    ...
    public static String getTempFilename(String address) {
        ...
        if (address != null) {
            try {
                ...
                logger.warning("failed to create temporary file: " + e);
            }
        }
        return filename;
    }
