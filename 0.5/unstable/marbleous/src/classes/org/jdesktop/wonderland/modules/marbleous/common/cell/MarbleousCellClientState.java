...
/**
 * Container for Marbleous client cell client state data.
 *
 * @author deronj@dev.java.net
 */

public class MarbleousCellClientState extends App2DCellClientState {
    public MarbleousCellClientState () {
