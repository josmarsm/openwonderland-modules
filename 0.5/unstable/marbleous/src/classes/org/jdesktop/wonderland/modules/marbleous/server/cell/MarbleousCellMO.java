...
/**
 * A server cell for the Marble Roller Coaster.
 *
 * @author deronj@dev.java.net
 */
public class MarbleousCellMO extends App2DCellMO {

    /** Default constructor, used when the cell is created via WFS */
    public MarbleousCellMO() {
        super();
    }
    ...
    protected String getClientCellClassName(WonderlandClientID clientID, ClientCapabilities capabilities) {
        return "org.jdesktop.wonderland.modules.marbleous.client.cell.MarbleousCell";
    }
    ...
    protected CellClientState getClientState(CellClientState cellClientState, WonderlandClientID clientID, 
        ...
        if (cellClientState == null) {
            cellClientState = new MarbleousCellClientState();
        }
