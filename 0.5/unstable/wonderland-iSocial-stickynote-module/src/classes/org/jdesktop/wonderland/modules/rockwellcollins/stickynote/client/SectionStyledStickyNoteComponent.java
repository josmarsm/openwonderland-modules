 ...
 */
@ExperimentalAPI
public class SectionStyledStickyNoteComponent extends CellComponent {
     ...
     */
    public SectionStyledStickyNoteComponent(Cell cell) {
        super(cell);
        this.cell = (SectionStyledStickyNoteCell) cell;
    ...
    protected void setStatus(CellStatus status, boolean increasing) {
        switch (status) {
                    ...
                    if (msgReceiver == null) {
                        msgReceiver = new ChannelComponent.ComponentMessageReceiver() {
                            ...
                            public void messageReceived(CellMessage message) {
                                ...
                                SectionStyledStickyNoteSyncMessage msg = (SectionStyledStickyNoteSyncMessage) message;
                                cell.processMessage(msg);
                            }
                        };
                        channelComp.addMessageReceiver(SectionStyledStickyNoteSyncMessage.class, msgReceiver);
                    }
            ...
            case DISK:
                if (msgReceiver != null) {
                    channelComp.removeMessageReceiver(SectionStyledStickyNoteSyncMessage.class);
                    msgReceiver = null;
                }
                channelComp = null;
                break;
     ...
     */
    public void sendMessage(SectionStyledStickyNoteSyncMessage msg) {
